...
//        requestQueue.add(jsonObjectRequest);
//    }
//public static MutableLiveData<User_Check_User_Read> chek_user;
//    public void checkUser(String email){
//        chek_user = new MutableLiveData<>();
//        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, "https://anmolcoder.pythonanywhere.com/user/checkUser/"+email, null, new Response.Listener<JSONObject>() {
//            @Override
//            public void onResponse(JSONObject response) {
//                Log.e("ChekUser",String.valueOf(response));
//                User_Check_User_Read us = new User_Check_User_Read(String.valueOf(response));
//                chek_user.postValue(us);
//            }
//        }, new Response.ErrorListener() {
//            @Override
//            public void onErrorResponse(VolleyError error) {
...
//                User_Check_User_Read us = new User_Check_User_Read(a);
//                Check.postValue(us);
//            }
//        }, new Response.ErrorListener() {
//            @Override
