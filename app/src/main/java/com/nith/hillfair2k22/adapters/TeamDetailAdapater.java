...
public class TeamDetailAdapater extends RecyclerView.Adapter<TeamDetailAdapater.MyViewHolder> {
    private final Context context;
    private final List<Team> teamDetailList;

    public TeamDetailAdapater(List<Team> teamDetailList, Context context) {
    ...
    @NonNull
    @Override
    public TeamDetailAdapater.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder detailholder, int position) {
        Team teamDetail = teamDetailList.get(position);
//       detailholder.teamNameTextView.setText(teamDetail.getTeam_Name());
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View detailview) {
            super(detailview);
            teamNameTextView = (TextView) detailview.findViewById(R.id.team_name);
